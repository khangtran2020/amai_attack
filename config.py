...
def add_general_group(group):
    ...
    group.add_argument("--val_mode", type=str, default='test', help="Mode of training [clean, dp, target]")
...
def add_model_group(group):
    ...
    group.add_argument("--over_samp", type=int, default=10)


def add_defense_group(group):
    group.add_argument('--epsilon', type=float, default=1.0, help="epsilon")
    group.add_argument('--test_epsilon', type=float, default=1.0, help="epsilon")
    group.add_argument('--reg', type=float, default=0.1, help="epsilon")
