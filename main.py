...
def run(args, device):
    ...
    test_loader = torch.utils.data.DataLoader(
        AMIADatasetCelebA(args, target, transform, args.data_path, 'test', imgroot=None, multiplier=100),
        shuffle=False,
        num_workers=0, batch_size=200000)
    ...
    SAVE_NAME = 'CELEBA_embed_Lap_single_{}_{}.json'.format(args.num_target, args.epsilon)
